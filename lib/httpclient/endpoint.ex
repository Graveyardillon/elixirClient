defmodule Httpclient.Endpoint do
  use Plug.Router
  use Plug.Debugger
  use Plug.ErrorHandler

  alias Httpclient.Router
  ...
  defp config, do: Application.fetch_env(:httpclient, __MODULE__)
  defp redirect_url, do: Application.get_env(:httpclient, :redirect_url)
